...
Once in the parks, you can save time by paying to skip the queue for some rides (the cost varies between around 1,000 and 2,500 yen per ride per person). This is all done through the Tokyo Disney app, which also allows you to book restaurants and shows etc.
